$(document).ready(function() {
	...
	// select2 
      ...
      if ($.fn.select2) {
		...
		$("#name-tags").select2({
          tags:["sharath", "obi", "swathi", "prathap", "srinivas"],
          tokenSeparators: [",", " "]}
        );
        $("#team-tags").select2({
          tags:["WCS", "JAVA", "Dotnet", "POS", "Testing"],
          tokenSeparators: [",", " "]}
        );
		$("#lead-tags").select2({
          tags:["Prudhvi", "Ramesh", "Srinivas", "Bharath", "Bhaskar", "Vijay"],
          tokenSeparators: [",", " "]}
        );
		$("#status-tags").select2({
        ...
        $("#project-tags").select2({
          tags:["TGG", "Transre", "US", "TGG retailer", "something", "anything", "something2", "something3", "something5", "everything1", "everything2", "everything3", "everything4", "everything5"],
          tokenSeparators: [",", " "]}
        );
    }

	//creating a tooltip for comments to show the content in the comments
    $('body').tooltip({
        selector: "[data-tooltip=tooltip]",
        container: "body"
    });
	
	$(".startTime").val("09:30:00");//set default starting time in attendance page
    
	$(".sourceProj").sortable({connectWith: ".targetProj"});
	$(".targetProj").sortable({connectWith: ".sourceProj"});
